...
func main() {
	...
	hihatPlayer := addDrumTrack(env, "hihat", hihatSound, bpm, 4, 0.875, 1.125, 1.0, value.NewAnd([]value.Valuer[*swing.Step]{
	...
	kickPlayer := addDrumTrack(env, "kick", kickSound, bpm, 4, 0.875, 1.125, 1.0, value.NewAnd([]value.Valuer[*swing.Step]{
		value.NewRepeat[*swing.Step](value.NewSequenceNC([]*swing.Step{
